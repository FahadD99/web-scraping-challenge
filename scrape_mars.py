...
def init_browser():
    # chromedriver, thank you Dan for your help with this and directing me to Chromedriver
...
def scrape():
    ...
    latest_summary = latest.find(class_='rollover_description_inner').get_text()
